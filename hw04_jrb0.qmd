...
✅ Submit an `app.R` file that runs correctly. ✅ Push your project to a public **GitHub** repository with **at least one commit**. ✅ Publish your app to **shinyapps.io**. ✅ **Paste the following two links into the Canvas text submission box**:
